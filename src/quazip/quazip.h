 ...
 *
 * This class is intended to provide an interface to the ZIP subpackage of
 * the ZIP/UNZIP package as well as to the UNZIP subpackage. But
 * currently it supports only UNZIP.
 *
 * The use of this class is simple - just create an instance using the
 * constructor, then set ZIP an archive file name using setFile() function
 ...
 * function is not much trouble, but for true platform independent it
